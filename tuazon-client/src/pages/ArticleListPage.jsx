...
const ArticleListPage = () => {
  ...
  <section
    className="border-y-2 border-[#c97b84] bg-[#F5EDE6] px-4 py-6 sm:px-6 sm:py-8 lg:px-8"
  >
    <p
      className="mb-3 text-[11px] font-semibold uppercase tracking-[0.28em] text-[#C97B84]"
    >
      Articles
    </p>

    <h1
      className="max-w-xl text-3xl font-bold leading-tight text-[#5A2A6E] sm:text-4xl"
    >
